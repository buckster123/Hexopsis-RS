...
**Implemented.** v1 S0–S12 is on `main` (2026-08-19). Garden name is now **Hexopsis-RS** (Tessera-RS vacated). This note is the PRD-write provenance, not the runbook — see `docs/STATUS.md` and `docs/USER.md`.
